# Soul
A python program to visually model various states of The Soul with precise detail. Considered to be in beta-stage.
...
The "E" option is to indicate an emotion is sourced from Empathy (mirror neurons). However, with Trust & Disgust it simply means self-trust or self-disgust.
